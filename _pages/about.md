...
I am currently working on Bayesian clustering for satellite images. Our work not only helps detect existing land cover types but also can discover new land uses and allow spatial correlation to provide more accurate uncertainty quantification. I also work on Bayesian Deep Learning, where I develop novel approaches for better prior choice and posterior approximation in big data cases.
